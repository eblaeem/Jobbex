				...
				if(v.type != 'unknown') {
					...
					if(v.thumb) {
						...
						switch(v.type) {
							...
							case 'dailymotion' 	: bg_img = (v.poster) ? v.poster : '../../www.dailymotion.com/thumbnail/video/'+ v.video_id; break;
						}
		...
		$(document).on('click', '.lcl_socials', function(e) {
			...
			if(!$('.lcl_socials > div').length) {
				...
				'<div class="lcl_socials_tt lcl_tooltip lcl_tt_bottom">';
					...
					code += '<a class="lcl_icon lcl_twit" onClick="window.open(\'https://twitter.com/share?text=Check%20out%20%22'+ title +'%22%20_40&url='+ page_url +'\',\'sharer\',\'toolbar=0,status=0,width=548,height=325\');" href="javascript: void(0)"></a>';
					
					// on mobile - use Whatsapp
					if(lcl_on_mobile) {
						code += '<br/><a class="lcl_icon lcl_wa" href="../../https@thewebmax.org\jobzilla\whatsapp_3a\\send@text='+ page_url +'" data-action="share/whatsapp/share"></a>'; 	
					}
