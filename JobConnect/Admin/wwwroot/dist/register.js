System.register(["./common-service.js", "./fetch-service.js", "./message-service.js"], function (exports_1, context_1) {
    ...
    var common_service_js_1, fetch_service_js_1, message_service_js_1, Register;
    ...
    return {
        ...
        execute: function () {
            Register = (function () {
                ...
                Register.prototype.submit = function (target) {
                    return __awaiter(this, void 0, void 0, function () {
                        var data;
                        return __generator(this, function (_a) {
                            data = common_service_js_1.default.getFormData('register-form');
                            fetch_service_js_1.default.post('/user/register', data).then(function (response) {
                                if (!response.isValid) {
